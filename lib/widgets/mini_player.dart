...
class _MultiMiniPlayerState extends State<MultiMiniPlayer> {
  ...
  Widget build(BuildContext context) {
    ...
    if (hasAudio && hasVideo) {
      if (audioProvider.isPlaying &&
          ...
          _lastVideoPlaying) {
        _audioOnTop = true;
      } else if (videoProvider.isPlaying &&
  ...
  Widget _buildAnimatedCard(
    ...
    if (provider == null || provider.currentFilePath == null)
    ...
    return AnimatedPositioned(
      ...
      child: AnimatedScale(
        ...
        child: AnimatedOpacity(
          ...
          child:
              _buildMiniCard(context, provider, isVideo: isVideo, isTop: isTop),
        ),
      ),
    );
  }

  Widget _buildMiniCard(BuildContext context, dynamic provider,
      {required bool isVideo, required bool isTop}) {
              ...
              children: [
                ...
                if (isTop) ...[
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      if (isVideo) {
                        provider.stopBackgroundPlayback(
                            stopPlayer: provider.isPlaying);
                      } else {
